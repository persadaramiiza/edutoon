...
| `DB_PORT`                    | port MariaDB, umumnya 3306               |
...
Target yang dimaksud adalah Amazon RDS for MariaDB. Template di `k8s/overlays/rds-disabled` tidak memiliki `kustomization.yaml`, sehingga tidak termasuk deployment lokal. Aktivasi memerlukan persetujuan perusahaan, akses jaringan, pemeriksaan CA, backup, schema audit, dan rencana rollback.
