            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {profiles.map((profile, index) => (
                ...
                >
                  ...
                  >
                    <div className="flex flex-col items-center p-6 rounded-[1.5rem] hover:bg-[#FFF9F0] border-2 border-transparent hover:border-[#FFE0B2] transition-all duration-300 group-hover:scale-105 cursor-pointer">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 bg-[#D94D2B] text-white w-8 h-8 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[#B93D1B] shadow-lg flex items-center justify-center z-20"
                  >
