    ...
    <div className="min-h-screen bg-[#FFF9F0] font-sans text-[#4A4A4A] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        <motion.div 
          ...
          className="bg-white rounded-[2rem] shadow-xl border-b-8 border-[#FFE0B2] p-8 sm:p-12"
        >
          ...
          {profiles.length === 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {profiles.map((profile, index) => (
                ...
                >
                  <motion.button
                    ...
                    className="w-full flex flex-col items-center p-6 rounded-[1.5rem] hover:bg-[#FFF9F0] border-2 border-transparent hover:border-[#FFE0B2] transition-all duration-300"
                  >
              ...
              <motion.button
                ...
                className="flex flex-col items-center p-6 rounded-[1.5rem] border-4 border-dashed border-[#FFE0B2] hover:border-[#FF7A00] hover:bg-[#FFF5E5] transition-all duration-300 group"
              >
        ...
        {showAddProfile && (
          ...
          >
            <motion.div 
              ...
              className="w-full max-w-md bg-white rounded-[2rem] shadow-2xl border-b-8 border-[#FFE0B2] p-8"
            >
