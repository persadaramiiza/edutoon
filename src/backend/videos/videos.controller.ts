...
export class VideosController {
  ...
  // ==================== GET RECOMMENDATIONS ====================
  @Get('recommendations')
  @ApiOperation({ summary: 'Get video recommendations based on age group' })
  async getRecommendations(
    @Query('age_group', ParseIntPipe) ageGroup: number,
  ) {
    return this.videosService.getRecommendations(ageGroup);
  }
